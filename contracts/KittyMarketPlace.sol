...
contract KittyMarketPlace is KittyOwnership {
    ...
    public
  {
    ...
    */
    require(_price > 0.009 ether, "Fish price should be greater than 0.01");
    ...
    public
  {
    ...
    require(offer.seller == msg.sender, "You should own the Fish to be able to remove this offer");
