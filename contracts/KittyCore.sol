...
*/
  function Breeding(uint256 _dadId, uint256 _mumId) public {
      ...
      require(_mumId != _dadId, "The Fish can't reproduce himself");
      ...
      if (DadGeneration == 999 || MumGeneration == 999) { 
        kidGen = 999;
      }
  ...
  function createFishGen0(uint256 _genes) public onlyOwner {
    ...
    if(gen0Counter <= 10) { 
      ...
      _createKitty(0, 0, 999, _genes, msg.sender);
    }
  }
  ...
  function getKitty(uint256 _id)
    ...
    require(kitty.birthTime > 0, "the Fish doesn't exist");
